...
namespace FoodShareNet.Repository.Migrations
{
    ...
    [Migration("20240410225532_UpdatedProductAndCities")]
    partial class UpdatedProductAndCities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodShareNet.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Image = "https://www.tastingtable.com/img/gallery/20-tricks-to-make-your-tomatoes-even-more-delicious/intro-1684770527.jpg",
                            Name = "Tomatoes"
                        },
                        new
                        {
                            Id = 2,
                            Image = "https://www.foodrepublic.com/img/gallery/10-things-you-probably-didnt-know-about-potatoes/l-intro-1689785695.jpg",
                            Name = "Potatoes"
                        },
                        new
                        {
                            Id = 3,
                            Image = "https://staticcookist.akamaized.net/wp-content/uploads/sites/22/2020/06/meat-1200x675.jpg",
                            Name = "Meat"
                        });
                });
